...
const AdminMain = () => {
  ...
  const handleDeleteCard = async (cardId: string) => {
    if (!confirm('¿Est&aacute;s seguro de que quieres eliminar esta card?')) return
  ...
  return (
    <div style={styles.body}>
      ...
      <header style={styles.header}>
        <div style={styles.headerContent}>
          <h1 style={styles.title}>
            {store?.name || 'Panel de Administraci&oacute;n'}
          </h1>
        </div>
      </header>
      ...
      <main style={styles.main}>
        ...
        <div style={styles.card}>
          <h2 style={styles.sectionTitle}>Informaci&oacute;n de la Tienda</h2>
        ...
        <div style={styles.card}>
          ...
          <p style={styles.infoText}>
            Configuraci&oacute;n del encabezado y pie de p&aacute;gina
          </p>
        </div>
      </main>

      ...
      if (response.ok) {
        ...
        if (foundCard) {
          ...
          setFormData({
            ...
            image1Url: foundCard.image1Url || '',
            image2Url: foundCard.image2Url || '',
            image3Url: foundCard.image3Url || ''
          })
        }
      }
    } catch (error) {
      ...
      <div style={styles.body}>
        <div style={styles.main}>
          <div style={styles.form}>
            <h2 style={styles.formTitle}>Cargando...</h2>
          </div>
        </div>
      </div>
    )
  ...
  if (!card) {
    return (
      <div style={styles.body}>
        <div style={styles.main}>
          <div style={styles.form}>
            <h2 style={styles.formTitle}>Card no encontrada</h2>
    ...
    <div style={styles.body}>
      ...
      <header style={styles.header}>
        <div style={styles.headerContent}>
          ...
          <h1 style={styles.title}>Editar Card</h1>
        </div>
      </header>
                    ...
                    {imageUrl ? (
                      ...
                      >
                        ...
                        <p style={styles.uploadText}>
                          {isUploading ? 'Subiendo...' : `Imagen ${num}`}
                        </p>
                        <input
                          id={`file-${num}`}
                          type="file"
